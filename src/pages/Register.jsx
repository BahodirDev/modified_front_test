...
function Register(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!status) {
            ...
            if(isTeacher == ''){
                return toast.error("FAN NOMINI KIRITING");
            }
        ...
        <div className='row p-4'>
            <div className="col-md-12 col-12 mt-4 ">
                <form className='p-3' onSubmit={handleSubmit}>
                    ...
                    <button type='submit' disabled={ status == 'teacher' && (isTeacher == '' || isTeacher == 'false')} className='btn btn-outline-success mt-2 w-100' onClick={handleSubmit}>KIRISH</button>
                    {/* </div> */}
                </form>
            </div>
        </div>
